...
r_name = []
name1 = []
image_path = u'C:/Users/rkdau/OneDrive/바탕 화면/코딩/2023-1-Capstone-/example/webcam/faces/*.png'
...
def load_image_file_utf8(file, mode='RGB'):
    with io.open(file, 'rb') as f:
        image = Image.open(f).convert(mode)
...
class Facerecognition:
    ...
    def encode_faces(self):
        ...
        for image in glob.glob(image_path):
            face_image = load_image_file_utf8(image)
